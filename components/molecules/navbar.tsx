...
const Navbar = () => {
  ...
  return (
    ...
    <div className="bg-black text-white text-md flex h-10 justify-center items-center w-full p-2">We Are Coming Soon <Heart fill="red" className="text-red-600 h-5 mx-2"></Heart></div>
