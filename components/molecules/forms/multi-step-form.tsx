...
export const FormDataSchema = z.object({
  ...
  businessCountryOfRegistration: z
    .string()
    .min(2, { message: "businessType of registration is required." }),
  ...
  totalProductionPerYear: z
    .number()
    .positive({ message: "Production must be a positive number." })
    .optional(),
  numberOfSuppliers: z
    .number()
    .int()
    .positive({ message: "Number of suppliers must be a positive integer." })
    .optional(),
  supplyChainDescription: z
    .string()
    .min(50, {
      message: "Supply chain description must be at least 50 characters.",
    })
    .optional(),
  manufacturingProcesses: z
    .string()
    .min(20, {
      message: "Manufacturing processes must be at least 20 characters.",
    })
    .optional(),

  // Resource Usage
  electricityConsumption: z
    .number()
    .positive({ message: "Electricity consumption must be a positive number." })
    .optional(),
  waterConsumption: z
    .number()
  ...
  wastePercentage: z
    .number()
    .min(0)
    .max(100, { message: "Waste percentage must be between 0 and 100." })
    .optional(),
  recycledPercentage: z
    .number()
    .min(0)
    .max(100, { message: "Recycled percentage must be between 0 and 100." })
    .optional(),

  // Packaging
  packagingMaterials: z.string().min(5, {
    message: "Please describe packaging materials (at least 5 characters).",
  }),
...
export default function Form() {
  ...
  const handleNumberChange = (field: any, value: any) => {
    ...
    setValue(field, isNaN(parsedValue) ? "" : parsedValue, {
      shouldValidate: true,
    });
  };
                ...
                <div className="mt-2">
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="Mens"
                      onChange={() =>
                        handleCheckboxChange("categories", "Mens")
                      }
                    />
                    <p>Men&apos;s Clothing</p>
                  </div>
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="Womens"
                      onChange={() =>
                        handleCheckboxChange("categories", "Womens")
                      }
                    />
                  ...
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="Kids"
                      onChange={() =>
                        handleCheckboxChange("categories", "Kids")
                      }
                    />
                    <p>Kid&apos; Fashion</p>
                  </div>
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="HomeAndDecor"
                      onChange={() =>
                        handleCheckboxChange("categories", "HomeAndDecor")
                      }
                    />
                    <p>Home and Living</p>
                  </div>
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="Accessories"
                      onChange={() =>
                        handleCheckboxChange("categories", "Accessories")
                      }
                    />
                    <p>Accessories</p>
                  </div>
                ...
                <div className="mt-2 flex flex-col gap-2">
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="NoPoverty"
                      onChange={() =>
                        handleCheckboxChange("unSdgs", "No Poverty")
                      }
                    />
                    <p>No Poverty</p>
                  </div>
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="ZeroHunger"
                      onChange={() =>
                        handleCheckboxChange("unSdgs", "Zero Hunger")
                      }
                    />
                    <p>Zero Hunger</p>
                  </div>
                  ...
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="QualityEducation"
                      onChange={() =>
                        handleCheckboxChange("unSdgs", "Quality Education")
                      }
                    />
                  ...
                  <div className="flex justify-start items-center gap-1">
                    <input
                      ...
                      id="GenderEquality"
                      onChange={() =>
                        handleCheckboxChange("unSdgs", "Gender Equality")
                      }
                    />
                    <p>Gender Equality</p>
                  </div>
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    {...register("totalProductionPerYear", {
                      valueAsNumber: true,
                    })}
                    className="block w-full rounded-md border-0 py-1.5 px-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
                  />
